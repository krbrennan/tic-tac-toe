...
function App() {
  ...
  function Square({id, value, onSquareClick}) {
    const isThisAWinningSquare = this.winningCombo.includes(id) ? true : false
    ...
    return(
      ...
      <div className="reset-btn-container">
        ...
        <div className="row r-3">
          <Square id={6} onSquareClick={()=> {handleClick(6)}} value={squares[6]} id="cell-7" />
          <Square id={7} onSquareClick={()=> {handleClick(7)}} value={squares[7]} id="cell-8" />
          <Square id={8} onSquareClick={()=> {handleClick(8)}} value={squares[8]} id="cell-9" />
        </div>
    </>
    )
  }
