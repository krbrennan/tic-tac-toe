    ...
    return(
      <>
        <div className="row r-1">
          <Square value={squares[0]} id="cell-1" />
          <Square value={squares[1]} id="cell-2" />
          <Square value={squares[2]} id="cell-3" />
        </div>
        <div className="row r-2">
          <Square value={squares[3]} id="cell-4" />
          <Square value={squares[4]} id="cell-5" />
          <Square value={squares[5]} id="cell-6" />
        </div>
        <div className="row r-3">
          <Square value={squares[6]} id="cell-7" />
          <Square value={squares[7]} id="cell-8" />
          <Square value={squares[8]} id="cell-9" />
        </div>
    </>
    )
  }
