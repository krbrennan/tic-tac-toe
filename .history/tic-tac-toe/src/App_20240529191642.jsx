...
function App() {
  ...
  function Board(){
    ...
    function checkIfWinner(squares){
      ...
      xIsNext == true ? currentLetter = "X" : "O"
      ...
      const currentPlayerMoves = squares.filter((move) => { 
        return move == currentLetter 
      })
      // const result = words.filter((word) => word.length > 6);

      console.log("current player moves",currentPlayerMoves)
    }
